...
@OriginalClass("client!HZTFWEML")
public class BZip2 {

    @OriginalMember(owner = "client!HZTFWEML", name = "a", descriptor = "LQPNUVGRI;")
    private static BZip2State state = new BZip2State();

    @OriginalMember(owner = "client!HZTFWEML", name = "a", descriptor = "([BI[BII)I")
    ...
    @OriginalMember(owner = "client!HZTFWEML", name = "a", descriptor = "(LQPNUVGRI;)V")
    private static void finish(BZip2State arg0) {
    ...
    @OriginalMember(owner = "client!HZTFWEML", name = "b", descriptor = "(LQPNUVGRI;)V")
    private static void decompress(BZip2State arg0) {
        boolean var4 = false;
        boolean var5 = false;
        boolean var6 = false;
        boolean var7 = false;
        ...
        while (true) {
            while (var27) {
                ...
                arg0.origPtr = 0;
                var1 = getUnsignedChar(arg0);
                arg0.origPtr = arg0.origPtr << 8 | var1 & 255;
                var1 = getUnsignedChar(arg0);
                arg0.origPtr = arg0.origPtr << 8 | var1 & 255;
                var1 = getUnsignedChar(arg0);
                arg0.origPtr = arg0.origPtr << 8 | var1 & 255;
                ...
                int var53 = 100000 * arg0.blockSize100k;
                int var49 = -1;
                byte var50 = 0;
                ...
                while (true) {
                    while (var52 != var48) {
                        if (var52 != 0 && var52 != 1) {
                            ...
                            BZip2State.tt[var54] = arg0.seqToUnseq[var1 & 255] & 255;
                            var54++;
                            if (var51 == 0) {
                                var49++;
                                var51 = 50;
                            ...
                            var55++;
                            var1 = arg0.seqToUnseq[arg0.mtfa[arg0.mtfbase[0]] & 255];
                            arg0.unzftab[var1 & 255] += var55;
                            while (var55 > 0) {
                                BZip2State.tt[var54] = var1 & 255;
                                var54++;
                                var55--;
                            }
                        }
                    ...
                    for (var42 = 0; var42 < var54; var42++) {
                        var1 = (byte) (BZip2State.tt[var42] & 255);
                        BZip2State.tt[arg0.cftab[var1 & 255]] |= var42 << 8;
                        arg0.cftab[var1 & 255]++;
                    }
                    arg0.tPos = BZip2State.tt[arg0.origPtr] >> 8;
                    arg0.c_nblock_used = 0;
                    arg0.tPos = BZip2State.tt[arg0.tPos];
                    arg0.k0 = (byte) (arg0.tPos & 255);
                    arg0.tPos >>= 8;
                    arg0.c_nblock_used++;
    ...
    @OriginalMember(owner = "client!HZTFWEML", name = "c", descriptor = "(LQPNUVGRI;)B")
    private static byte getUnsignedChar(BZip2State arg0) {
        return (byte) getBits(8, arg0);
    }

    @OriginalMember(owner = "client!HZTFWEML", name = "d", descriptor = "(LQPNUVGRI;)B")
    private static byte getBit(BZip2State arg0) {
        return (byte) getBits(1, arg0);
    }

    @OriginalMember(owner = "client!HZTFWEML", name = "a", descriptor = "(ILQPNUVGRI;)I")
    private static int getBits(int arg0, BZip2State arg1) {
        while (arg1.bsLive < arg0) {
            arg1.bsBuff = arg1.bsBuff << 8 | arg1.stream[arg1.next_in] & 255;
            arg1.bsLive += 8;
            arg1.next_in++;
            arg1.avail_in--;
            arg1.total_in_lo32++;
        ...
        int var3 = arg1.bsBuff >> arg1.bsLive - arg0 & (1 << arg0) - 1;
        arg1.bsLive -= arg0;
        return var3;
    }

    @OriginalMember(owner = "client!HZTFWEML", name = "e", descriptor = "(LQPNUVGRI;)V")
    private static void makeMaps(BZip2State arg0) {
        arg0.nInUse = 0;
    ...
    @OriginalMember(owner = "client!HZTFWEML", name = "a", descriptor = "([I[I[I[BIII)V")
    private static void createDecodeTables(int[] arg0, int[] arg1, int[] arg2, byte[] arg3, int arg4, int arg5, int arg6) {
        int var7 = 0;
        int var8;
