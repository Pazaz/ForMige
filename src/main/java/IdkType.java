...
public class IdkType {
    ...
    @OriginalMember(owner = "client!TAVAECED", name = "c", descriptor = "[LTAVAECED;")
    ...
    @OriginalMember(owner = "client!TAVAECED", name = "a", descriptor = "(ILXTGLDHGX;)V")
    public static void unpack(int arg0, Jagfile arg1) {
        Packet var2 = new Packet(arg1.read("idk.dat", (byte[]) null), 891);
        count = var2.g2();
        if (instances == null) {
    ...
    @OriginalMember(owner = "client!TAVAECED", name = "a", descriptor = "(ZLMBMGIXGO;)V")
    ...
    public boolean validateModel(byte arg0) {
        if (this.models == null) {
            ...
            for (var3 = 0; var3 < this.models.length; var3++) {
    ...
    @OriginalMember(owner = "client!TAVAECED", name = "a", descriptor = "(Z)LZKARKDQW;")
    ...
    @OriginalMember(owner = "client!TAVAECED", name = "a", descriptor = "(I)LZKARKDQW;")
