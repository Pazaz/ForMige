...
public class VarpType {
    ...
    @OriginalMember(owner = "client!VGXVBFVC", name = "d", descriptor = "[LVGXVBFVC;")
    ...
    @OriginalMember(owner = "client!VGXVBFVC", name = "a", descriptor = "(ILXTGLDHGX;)V")
    public static void unpack(int arg0, Jagfile arg1) {
        Packet var2 = new Packet(arg1.read("varp.dat", (byte[]) null), 891);
        field1489 = 0;
        count = var2.g2();
        if (instances == null) {
    ...
    @OriginalMember(owner = "client!VGXVBFVC", name = "a", descriptor = "(LMBMGIXGO;ZI)V")
