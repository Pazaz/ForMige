...
public class SeqType {
    ...
    @OriginalMember(owner = "client!LKGEGIEW", name = "d", descriptor = "[LLKGEGIEW;")
    ...
    @OriginalMember(owner = "client!LKGEGIEW", name = "t", descriptor = "I")
    public static int _flowObfuscator3;

    @OriginalMember(owner = "client!LKGEGIEW", name = "a", descriptor = "(ILXTGLDHGX;)V")
    public static void unpack(int arg0, Jagfile arg1) {
        Packet var2 = new Packet(arg1.read("seq.dat", (byte[]) null), 891);
        count = var2.g2();
        if (instances == null) {
    ...
    @OriginalMember(owner = "client!LKGEGIEW", name = "a", descriptor = "(ZLMBMGIXGO;)V")
