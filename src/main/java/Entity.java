...
public class Entity extends DoublyLinkable {
    ...
    @OriginalMember(owner = "client!XHHRODPC", name = "j", descriptor = "[LRJXWGZGD;")
    public VertexNormal[] vertexNormal;

    @OriginalMember(owner = "client!XHHRODPC", name = "k", descriptor = "I")
    public int minY = 1000;

    @OriginalMember(owner = "client!XHHRODPC", name = "l", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!XHHRODPC", name = "a", descriptor = "(I)LZKARKDQW;")
